 ...
 */
export declare const BlocProvider: <Bloc extends ClassType<BlocBase<any>>>({ bloc, children, dependencies, create, onMount, }: BlocProviderProps<Bloc>) => import("react").FunctionComponentElement<import("react").ProviderProps<import("..").ProviderContext>>;
/**
