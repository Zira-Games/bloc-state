 ...
 */
export declare const Provider: <Class extends AnyClassType>({ children, classDef, dependencies, disposeTime, create, onMount, onUnmount, }: ProviderProps<Class>) => import("react").FunctionComponentElement<import("react").ProviderProps<import("../context").ProviderContext>>;
