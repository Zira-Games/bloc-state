 ...
 */
export declare const rootContext: import("react").Context<ProviderContextMap | undefined>;
/**
 ...
 */
export declare const createCachedContext: (contextMap: ProviderContextMap, classDef: AnyClassType) => import("react").Context<ProviderContext>;
