...
export declare const RepositoryProvider: <Repository extends ClassType<any>>({ repository, children, dependencies, create, onMount, onUnmount, }: RepositoryProviderProps<Repository>) => import("react").FunctionComponentElement<import("react").ProviderProps<import("..").ProviderContext>>;
